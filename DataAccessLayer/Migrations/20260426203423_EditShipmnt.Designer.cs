...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20260426203423_EditShipmnt")]
    partial class EditShipmnt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domains.Models.TbShippmentStatus", b =>
                {
                    ...
                    b.HasOne("Domains.Models.TbShipment", "Shipment")
                        .WithMany("TbShippmentStatuses")
                        .HasForeignKey("ShippmentId")
                        .HasConstraintName("FK_TbShippmentStatus_TbShipments");
